          ...
          {posts.length === 0 ? (
            ...
            <div className="grid grid-cols-2 gap-8 max-[900px]:grid-cols-1">
              {posts.map((post) => (
                ...
                >
                  <article className="bg-bg-card overflow-hidden transition-colors duration-300 hover:bg-bg-elevated">
                    {/* Image */}
                    ...
                    <div className="p-6">
                      ...
                      {post.excerpt && (
                        <p className="text-[0.88rem] text-text-secondary leading-[1.7] line-clamp-2">
                          {post.excerpt}
                        </p>
                      )}
                    </div>
